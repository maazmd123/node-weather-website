        ...
        if(error)
{
    callback('Unable to connect to weather servise', undefined)
        ...
        callback(undefined, {
            forcast : `${body.current.weather_descriptions}. It is currently ${body.current.temperature} degrees out but it feels like it is ${body.current.feelslike} degree out`
